...
class Interpreter:
    ...
    def run(self):
        ...
        visitor.visit(tree)
        return visitor.output, visitor.variables, visitor.counter, visitor.input_values, visitor.number_of_read_numeric_var, visitor.number_of_inputs_after_reading_all_vars
